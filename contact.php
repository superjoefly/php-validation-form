...
<body>
      ...
      <div class="w3-card-4">
         <div class="w3-container w3-teal">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="w3-container">
              ...
              <input type="submit" name="submit" value="Submit" class="w3-margin w3-button w3-right w3-teal" onsubmit="return renderData()">
   ...
   <div class="w3-container w3-hide" id="data">
